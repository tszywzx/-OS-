...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200410:	d57ff0ef          	jal	ra,80200166 <clock_set_next_event>
            if (++ticks % TICK_NUM == 0) {
    80200414:	00004697          	auipc	a3,0x4
    80200418:	bfc68693          	addi	a3,a3,-1028 # 80204010 <ticks>
    8020041c:	629c                	ld	a5,0(a3)
    8020041e:	06400713          	li	a4,100
    80200422:	0785                	addi	a5,a5,1
    80200424:	02e7f733          	remu	a4,a5,a4
    80200428:	e29c                	sd	a5,0(a3)
    8020042a:	cb11                	beqz	a4,8020043e <interrupt_handler+0x7a>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200436:	b0e50513          	addi	a0,a0,-1266 # 80200f40 <etext+0x524>
    ...
    80200446:	aee50513          	addi	a0,a0,-1298 # 80200f30 <etext+0x514>
    8020044a:	c27ff0ef          	jal	ra,80200070 <cprintf>
                if(++num == 10)
    8020044e:	00004717          	auipc	a4,0x4
    80200452:	bca70713          	addi	a4,a4,-1078 # 80204018 <num>
    80200456:	631c                	ld	a5,0(a4)
    80200458:	46a9                	li	a3,10
    8020045a:	0785                	addi	a5,a5,1
    8020045c:	e31c                	sd	a5,0(a4)
    8020045e:	fcd797e3          	bne	a5,a3,8020042c <interrupt_handler+0x68>
}
...
void exception_handler(struct trapframe *tf) {
    ...
    80200480:	02e79563          	bne	a5,a4,802004aa <exception_handler+0x42>
             /* LAB1 CHALLENGE3   2211200 2212125 2213034 :  */
    ...
    802004c6:	b2650513          	addi	a0,a0,-1242 # 80200fe8 <etext+0x5cc>
    802004ca:	ba7ff0ef          	jal	ra,80200070 <cprintf>
            cprintf("ebreak caught at 0x%016llx\n", tf->epc);
    802004ce:	10843583          	ld	a1,264(s0)
    802004d2:	00001517          	auipc	a0,0x1
    802004d6:	b3650513          	addi	a0,a0,-1226 # 80201008 <etext+0x5ec>
